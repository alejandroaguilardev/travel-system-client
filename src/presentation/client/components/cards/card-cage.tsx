import { Card, Stack, Avatar, Divider, Typography, ListItemText, Box, Button, Alert, Chip, Badge } from '@mui/material';
...
export default function CardCage({ cage, onView }: Props) {
            ...
            <Box display="flex" justifyContent="center" my={2}>
                {
                    cage.hasServiceIncluded ?
                        ...
                        :
                        <Button variant='outlined' color="primary" fullWidth sx={{ width: "90%" }}>Ver Recomendación</Button>
                }
            </Box>
        </Card >
    );
